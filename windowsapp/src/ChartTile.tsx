...
export function ChartTile({ symbol, interval, supportedIntervals, onIntervalChange, candles = demo, onConfigure, onMaximize, maximized }: { symbol: string; interval: string; supportedIntervals: number[]; onIntervalChange: (interval: string) => void; candles?: Candle[]; onConfigure: () => void; onMaximize: () => void; maximized: boolean }) {
