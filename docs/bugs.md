...
**[FIXED — awaiting manual approval]** PE (or CE) options chart in Simulated Trading loses its completed candles after clicking the ↻ refresh button.
...
**[FIXED — awaiting manual approval]** ↻ refresh misses the most recently completed candle window for all chart types (CE, PE, Equity, Index).
...
**[FIXED — awaiting manual approval]** Trade History does not show trades from previous sessions on the same date for the same symbol + instrument type.
