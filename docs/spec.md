...
Include this phase in the context only when you are implementing or planning phase 1. The phase 1 docs is located at `<project root>/docs/spec-phase2.md`
...
#### Phase-VIII PaperTrading

Include this phase in the context only when you are implementing or planning phase 7. The phase 7 docs is located at `<project root>/docs/spec-phase8.md`
