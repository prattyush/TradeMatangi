...
Include this phase in the context only when you are implementing or planning phase 2. The phase 2 docs is located at `<project root>/docs/spec-phase2.md`
...
**Phase-II is complete.** Full implementation details, bugs fixed, and technology decisions are in `docs/spec-phase2.md`.
