...
| Phase XI — AI Helper | 🔨 PR #164 open (Sprint 3b: CE/PE markers on underlying chart, analysis price source setting, backend+frontend architecture docs; all OtherFeatures complete pending merge) | 534 backend / 227 aihelper | `docs/spec-phase11.md`, `docs/architecture-aihelper.md`, `docs/architecture-backend.md`, `docs/architecture-frontend.md` |
