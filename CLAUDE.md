...
| Phase XII — Trade Practice Tools | ✅ Complete (Stepwise Replayer + Pattern Library + LargeOrders + AIHelper Multi-SL + session resume PR #179 + stepwise add-CE/PE fix PR #181) | 624 backend / 291 aihelper | `docs/spec-phase12.md` |
